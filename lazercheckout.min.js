function LazerCheckout({
  ...
  function m() {
    ...
    u(document.querySelector(".lazer-section-four"), n),
      z(c),
      fetch("https://checkout.lazerpay.engineering/api/v1/initializePayment", {
        ...
        (l = e),
          r.subscribe("DEPOSIT_EVENT").bind(`${e.address}`, (n) => {
            y(n);
          });
      });
  }
  function x() {
    ...
    u(document.querySelector(".lazer-section-five"), n);
    l.address;
  ...
  function g() {
    navigator.clipboard.writeText(l.address);
  }
  function v() {
    u(
  ...
  function y(n) {
    ...
    u(t, e);
    const i = { address: l.address, key: a };
    fetch("https://checkout.lazerpay.engineering/api/v1/confirmPayment", {
      ...
      if ("error" === e.data.status) {
        u(document.querySelector(".lazer-section-nine"), t);
      }
      if ("confirmed" === e.data.status) {
        document
          .querySelectorAll(".lazer-section-success-amount")
          .forEach((n) => {
            n.innerText = `${l.amount} ${l.coin} `;
          }),
          (document.querySelector(
            ".lazer-section-PaidTODATA",
          ).innerText = `Paid to ${f}`),
          u(document.querySelector(".lazer-section-seven"), t);
      }
      if ("incomplete" === e.data.status) {
        (document.querySelector(
          ...
          u(document.querySelector(".lazer-section-eight"), t);
      }
    });
  }
  !(function (n) {
    ...
    if (n.key) {
      ...
      (t.src = e), (t.async = !0);
      const i = () => {
          r = new Pusher("be52401726705f906656", { cluster: "ap2" });
        },
        o = () => {
      ...
      w.classList.add("LazerCheckout-overlay");
      const L = document.createElement("div");
      L.classList.add("LazerCheckout-container-wrapper"),
        (L.innerHTML = (function (n) {
      ...
      const b = document.querySelector(".LazerCheckout-close-btn"),
        V = document.querySelector(".lazer-section-one"),
        S = document.querySelector(".lazer-section-two"),
        H = document.querySelector(".lazer-section-two-paymentOption"),
        E = document.querySelector(".lazer-section-three"),
        B =
          (document.querySelector(".lazer-section-four"),
          document.querySelector(".lazer-section-five"),
          document.querySelector(".lazer-section-six"),
        ...
        M = document.querySelector(".lazer-section-eight-request-refund"),
        k = document.querySelector("#lazer-section-six-made-transfer-tryAgain"),
        T = document.querySelector(".emailInput"),
        Z = document.querySelector(".phoneInput"),
        j = document.querySelectorAll(".lazer-section-three-coin-wrapper"),
        F = document.querySelector(".lazer-section-eight-complete-payment"),
        q = document.querySelector(".lazer-section-one-button");
      document.querySelector(".lazer-copy-button").addEventListener("click", g),
        ...
        H.addEventListener("click", () => u(E, S)),
        j.forEach((n, e) => {
              ...
              document
                ...
                fetch(
                  ...
                  .then(async (n) => {
                    ...
                    const t = r.subscribe("DEPOSIT_EVENT");
